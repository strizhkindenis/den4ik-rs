use crate::{RaylibHandle, color, container::Container, core::Camera};
...
impl<'l, 'h> Draw3DHandle<'l, 'h> {
    pub fn new(handle: &'l mut DrawHandle<'h>, camera: Camera) -> Self {
    ...
    pub fn draw_circle3_d(
        &mut self,
        center: crate::math::Vector3,
        radius: f32,
        rotation_axis: crate::math::Vector3,
        rotation_angle: f32,
        color: impl crate::color::ToRlColor,
    ) {
        unsafe {
            crate::ffi::DrawCircle3D(
                center.into(),
                radius,
                rotation_axis.into(),
                rotation_angle,
    ...
    pub fn draw_triangle3_d(
        &mut self,
        v1: crate::math::Vector3,
        v2: crate::math::Vector3,
        v3: crate::math::Vector3,
        color: impl crate::color::ToRlColor,
    ) {
    ...
    pub fn draw_cube_wires(
        ...
        unsafe {
            crate::ffi::DrawCubeWires(position.into(), width, height, length, color.to_rl_color())
        }
    }
...
impl<'h> DrawHandle<'h> {
    pub fn new(handle: &'h mut RaylibHandle) -> Self {
    ...
    pub fn begin_mode_3d<'l, F>(&'l mut self, f: F, camera: Camera)
    where
        F: FnOnce(Draw3DHandle<'l, 'h>),
    {
        let handle = Draw3DHandle::new(self, camera);
        f(handle)
    }
    ...
    pub fn draw_line_v(
        &mut self,
        start_pos: crate::math::Vector2,
        end_pos: crate::math::Vector2,
        color: impl crate::color::ToRlColor,
    ) {
    ...
    pub fn draw_line_ex(
        ...
        unsafe {
            crate::ffi::DrawLineEx(start_pos.into(), end_pos.into(), thick, color.to_rl_color())
        }
    }
    ...
    pub fn draw_line_bezier(
        ...
        unsafe {
            crate::ffi::DrawLineBezier(start_pos.into(), end_pos.into(), thick, color.to_rl_color())
        }
    }
    ...
    pub fn draw_circle_gradient(
        ...
        center: crate::math::Vector2,
        radius: f32,
        inner: impl crate::color::ToRlColor,
        outer: impl crate::color::ToRlColor,
    ) {
        unsafe {
            crate::ffi::DrawCircleGradient(
                center.into(),
                radius,
                inner.to_rl_color(),
                outer.to_rl_color(),
    ...
    pub fn draw_circle_sector_lines(
        ...
        unsafe {
            crate::ffi::DrawCircleSectorLines(
                center.into(),
                radius,
                start_angle,
                end_angle,
    ...
    pub fn draw_ellipse(
        ...
        unsafe {
            crate::ffi::DrawEllipse(center_x, center_y, radius_h, radius_v, color.to_rl_color())
        }
    }
    ...
    pub fn draw_ellipse_lines_v(
        ...
        unsafe {
            crate::ffi::DrawEllipseLinesV(center.into(), radius_h, radius_v, color.to_rl_color())
        }
    }
    ...
    pub fn draw_rectangle_pro(
        &mut self,
        rec: crate::math::Rectangle,
        origin: crate::math::Vector2,
        rotation: f32,
        color: impl crate::color::ToRlColor,
    ) {
        unsafe {
            crate::ffi::DrawRectanglePro(rec.into(), origin.into(), rotation, color.to_rl_color())
        }
    }
    ...
    pub fn draw_rectangle_gradient_v(
        ...
        width: i32,
        height: i32,
        top: impl crate::color::ToRlColor,
        bottom: impl crate::color::ToRlColor,
    ) {
        unsafe {
            crate::ffi::DrawRectangleGradientV(
                pos_x,
                pos_y,
                width,
                height,
    ...
    pub fn draw_rectangle_gradient_h(
        ...
        width: i32,
        height: i32,
        left: impl crate::color::ToRlColor,
        right: impl crate::color::ToRlColor,
    ) {
        unsafe {
            crate::ffi::DrawRectangleGradientH(
                pos_x,
                pos_y,
                width,
                height,
    ...
    pub fn draw_rectangle_gradient_ex(
        &mut self,
        rec: crate::math::Rectangle,
        top_left: impl crate::color::ToRlColor,
        bottom_left: impl crate::color::ToRlColor,
        bottom_right: impl crate::color::ToRlColor,
        top_right: impl crate::color::ToRlColor,
    ) {
        unsafe {
            crate::ffi::DrawRectangleGradientEx(
                rec.into(),
                top_left.to_rl_color(),
                bottom_left.to_rl_color(),
                bottom_right.to_rl_color(),
                top_right.to_rl_color(),
            )
        }
    }
    ...
    pub fn draw_rectangle_rounded(
        ...
        unsafe {
            crate::ffi::DrawRectangleRounded(rec.into(), roundness, segments, color.to_rl_color())
        }
    }
    ...
    pub fn draw_rectangle_rounded_lines(
        ...
        unsafe {
            crate::ffi::DrawRectangleRoundedLines(
                rec.into(),
                roundness,
                segments,
                color.to_rl_color(),
    ...
    pub fn draw_rectangle_rounded_lines_ex(
        ...
        unsafe {
            crate::ffi::DrawRectangleRoundedLinesEx(
                rec.into(),
                roundness,
                segments,
                line_thick,
    ...
    pub fn draw_triangle(
        &mut self,
        v1: crate::math::Vector2,
        v2: crate::math::Vector2,
        v3: crate::math::Vector2,
        color: impl crate::color::ToRlColor,
    ) {
    ...
    pub fn draw_triangle_lines(
        ...
        unsafe {
            crate::ffi::DrawTriangleLines(v1.into(), v2.into(), v3.into(), color.to_rl_color())
        }
    }
    ...
    pub fn draw_poly_lines(
        ...
        unsafe {
            crate::ffi::DrawPolyLines(center.into(), sides, radius, rotation, color.to_rl_color())
        }
    }
    ...
    pub fn draw_spline_segment_linear(
        &mut self,
        p1: crate::math::Vector2,
        p2: crate::math::Vector2,
        thick: f32,
        color: impl crate::color::ToRlColor,
    ) {
        unsafe {
            crate::ffi::DrawSplineSegmentLinear(p1.into(), p2.into(), thick, color.to_rl_color())
        }
    }
    ...
    pub fn draw_spline_segment_basis(
        ...
        p1: crate::math::Vector2,
        p2: crate::math::Vector2,
        p3: crate::math::Vector2,
        p4: crate::math::Vector2,
        thick: f32,
        color: impl crate::color::ToRlColor,
    ) {
        unsafe {
            crate::ffi::DrawSplineSegmentBasis(
                p1.into(),
                p2.into(),
                p3.into(),
                p4.into(),
    ...
    pub fn draw_spline_segment_catmull_rom(
        ...
        unsafe {
            crate::ffi::DrawSplineSegmentCatmullRom(
                p1.into(),
                p2.into(),
                p3.into(),
                p4.into(),
    ...
    pub fn draw_spline_segment_bezier_quadratic(
        &mut self,
        p1: crate::math::Vector2,
        c2: crate::math::Vector2,
        p3: crate::math::Vector2,
        thick: f32,
        color: impl crate::color::ToRlColor,
    ) {
        unsafe {
            crate::ffi::DrawSplineSegmentBezierQuadratic(
                p1.into(),
                c2.into(),
                p3.into(),
                thick,
    ...
    pub fn draw_spline_segment_bezier_cubic(
        ...
        p1: crate::math::Vector2,
        c2: crate::math::Vector2,
        c3: crate::math::Vector2,
        p4: crate::math::Vector2,
        thick: f32,
        color: impl crate::color::ToRlColor,
    ) {
        unsafe {
            crate::ffi::DrawSplineSegmentBezierCubic(
                p1.into(),
                c2.into(),
                c3.into(),
                p4.into(),
...
impl crate::RaylibHandle {
    pub fn begin_drawing<F>(&mut self, f: F)
    where
        F: FnOnce(DrawHandle),
    {
        let handle = DrawHandle::new(self);
        f(handle)
    }
}
